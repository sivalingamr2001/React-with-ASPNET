...
/// </summary>
public class EnhancedPostgreSqlProvider : IEnhancedDataProvider
{
    private readonly IEnhancedConnectionFactory _connectionFactory;
    private readonly DatabaseConfig _databaseConfig;
    private readonly ILogger<EnhancedPostgreSqlProvider> _logger;

    public EnhancedPostgreSqlProvider(
        IEnhancedConnectionFactory connectionFactory,
        DatabaseConfig databaseConfig,
        ILogger<EnhancedPostgreSqlProvider> logger)
    {
