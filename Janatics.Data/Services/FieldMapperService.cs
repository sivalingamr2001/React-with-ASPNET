...
namespace KATCRUDServices.Core.Services
{
    ...
    {
        private readonly IDataProvider _configDataProvider;
        private readonly ILogger<FieldMapperService> _logger;
      //  private readonly IConfiguration _configuration;

        public FieldMapperService(IDataProvider configDataProvider, ILogger<FieldMapperService> logger )
        {
        ...
        public async Task<List<FieldMapper>> GetFieldMappersAsync(string entityName, IDbTransaction? transaction = null)
        {
            try
            {
                var sql = @"
                ...
                foreach (System.Data.DataRow row in dataTable.Rows)
                {
                    mappers.Add(new FieldMapper
                    {
                        ...
                        AllowUpdate= row["allowupdate"] == DBNull.Value ? true : (bool)row["allowupdate"],
