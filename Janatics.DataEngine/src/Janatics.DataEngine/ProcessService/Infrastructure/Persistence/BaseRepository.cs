...
/// </summary>
public abstract class BaseRepository(IResilientConnectionFactory dataProvider, ILogger logger)
{
    protected readonly IResilientConnectionFactory _dataProvider = dataProvider ?? throw new ArgumentNullException(nameof(dataProvider));
