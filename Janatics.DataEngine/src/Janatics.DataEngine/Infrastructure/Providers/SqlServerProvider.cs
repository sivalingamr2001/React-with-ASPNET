...
namespace Janatics.DataEngine.Providers
{
    ...
    {   
        ...
        {
            using var command = new SqlCommand(sql, (SqlConnection)transaction.Connection, (SqlTransaction)transaction);
        ...
        public async Task<int> BulkInsertAsync(string tableName, DataTable dataTable, IDbTransaction transaction)
        {
            ...
            using var bulkCopy = new SqlBulkCopy((SqlConnection)transaction.Connection, SqlBulkCopyOptions.Default, (SqlTransaction)transaction)
            {
