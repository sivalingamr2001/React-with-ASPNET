...
namespace Janatics.DataEngine.ProcessService.Repositories;
...
/// </summary>
public abstract class BaseRepository(IResilientDataProvider dataProvider, ILogger logger)
{
    protected readonly IResilientDataProvider _dataProvider = dataProvider ?? throw new ArgumentNullException(nameof(dataProvider));
